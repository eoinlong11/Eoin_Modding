    ...
    public static final String VERSION = "1.0";
        ...
        public void preInit(FMLPreInitializationEvent event) {
        	...
        	MyCode.MyBlocks();
        	    ...
        	    //Mob Code
        	registerEntity(TestMob.class, "BadBoyHalo");
        	registerEntity(schmockyyy.class, "schmockyyy");
        	registerEntity(DeathBallEntity.class, "DEATHBALL");
        	registerEntity(bball0928.class, "Bball0928");
        }
        ...
        public static void registerRenderEntity(Class entityClass, String name)
        {
